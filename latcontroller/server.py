...
import sys
sys.path.insert(1, '/home/research/goworkspace/src/github.com/Ann-Geo/Latency_Controller/api/controller')
import grpc
...
def createHashtable(csvFile, upperAccLimit, lowerAccLimit):
	...
	knobs = []
	with open("/home/research/goworkspace/src/vsc_workspace/lat_meas/controller/all_combos.txt") as fileobj:
...
def loadData():
	...
	jaadSimpleHT = createHashtable("/home/research/goworkspace/src/vsc_workspace/lat_meas/controller/jaad/simple.csv", 0.476886, 0.47)
	jaadSimpleHT = OrderedDict((key, jaadSimpleHT[key]) for key in sorted(jaadSimpleHT))

	jaadMediumHT = createHashtable("/home/research/goworkspace/src/vsc_workspace/lat_meas/controller/jaad/medium.csv", 0.457737, 0.4)
	jaadMediumHT = OrderedDict((key, jaadMediumHT[key]) for key in sorted(jaadMediumHT))

	jaadComplexHT = createHashtable("/home/research/goworkspace/src/vsc_workspace/lat_meas/controller/jaad/complex.csv", 0.41989, 0.35)
...
def chooseDataset(accStr):
	...
	if targetDataset == "jaad":
		if targetRegime == "simple":
			...
			firstFrame = cv2.imread("/home/research/goworkspace/src/vsc_workspace/lat_meas/controller/jaad/firstframes/00110.png")

		elif targetRegime == "medium":
			targetDataset = jaadMediumHT
			firstFrame = cv2.imread("/home/research/goworkspace/src/vsc_workspace/lat_meas/controller/jaad/firstframes/00050.png")
		else:
			targetDataset = jaadComplexHT
			firstFrame = cv2.imread("/home/research/goworkspace/src/vsc_workspace/lat_meas/controller/jaad/firstframes/00230.png")
